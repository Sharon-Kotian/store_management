...
<body class="bg-light text-dark">
	...
	<h1 class="display-3" align="center">View Pending PO's</h1>
</header>
...
<div class="wrapper fadeInDown">
	<div id="formContent">
		<p align="center">
			<br><br>
			<a class="btn btn-primary btn-lg" href="ViewPOs.php?source=Supplier" ONCLICK="ShowRowMaterial()" style="width: 250px; height: 50px;">Supplier Wise</a>
			<a class="btn btn-primary btn-lg" href="ViewPOs.php?source=Date" ONCLICK="ShowProduct()" style="width: 250px; height: 50px;">Date Wise</a>
		</p>
					...
					case 'Supplier':
						...
						<?php	
							...
							while ($row = mysqli_fetch_assoc($raw_mat_query)) 
							{
								...
								echo "<td>$po_supp_id</td>";
								echo "<td>$po_ordered_date</td>";
								echo "<td>$po_due_date</td>";
							 echo "<td><a onClick=\"javascript: return confirm('Confirm your edit for the PO = $po_number?');\" href='POUpdate.php?id=". $row['po_number']."' role='button' class='btn btn-outline-warning btn-lg' aria-pressed='true'>Edit</a></td>";
							//echo "<td><a onClick=\"javascript: return confirm('Are you sure to delete the PO = $po_number?');\" class='btn btn-outline-danger btn-lg' href='PODelete.php?id=".$row['po_number']."'>Delete</a></td><tr>"; //use double quotes for js inside php!
							echo "<td><a onClick=\"javascript: return confirm('Are you sure to delete the PO = $po_number?');\" class='btn btn-outline-danger btn-lg'  href='PORecycle.php?id=".$row['po_number']."' role='button' aria-pressed='true'>Delete</a></td>";
