<?php 
	...
	if(isset($_POST['submit'])){
		...
		if($pass_match){
			echo '<script type="text/javascript">window.location.replace("UpdateOpeningStock.php")</script>';
		}

		else{
			echo '<script type="text/javascript">alert("Please enter correct password");
			window.location.replace("UpdateOpeningStock_Gatekeeper.php")</script>';
		}
	}
