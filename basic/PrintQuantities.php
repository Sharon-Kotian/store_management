...
<div class="wrapper fadeInDown">
	<div id="formContent">
		<p align="center"><a class="btn btn-primary btn-lg" style="width: 300px; height: 45px;" href="PrintQuantityVerification.php">Finished Product wise</a>
			<a class="btn btn-primary btn-lg" style="width: 300px; height: 45px;" href="PrintRawMatQuantity.php">Raw material wise</a></p>
	</div>
</div>	
