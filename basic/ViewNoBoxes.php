...
<header>
	...
	<h1 class="display-3" align="center">DIN Reprint</h1>
</header>
        ...
        <div id="formContent"><br><br>
            ...
            <tr align="center">									
				...
				<td align="center"><br><br><select name="po_number" id="po_number" style="width: 350px; height: 40px;">
					<?php
						$query=mysqli_query($connection, "SELECT po_number, po_din FROM po_summary WHERE po_status='Goods Received'");
						while($row=mysqli_fetch_array($query)){
							echo "<option value='".$row['po_number']."'>".$row['po_din']."</option>";
						}	
					?>
				</select> 
				</td>
...
<?php
	if(isset($_POST['submit'])){
		...
		echo '<script>window.open("PrintNoBoxes.php")</script>';
	};
