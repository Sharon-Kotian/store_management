<?php
	...
	if(isset($_POST['submit'])){
		...
		$insert_query=mysqli_query($connection, "UPDATE users SET user_pass='$user_pass' WHERE user_name='master'");
		if($insert_query){
			echo '<script type="text/javascript">alert("Password Updated Successfully.");
			window.location.replace("UpdateMasterPassword.php")</script>';
		}
		else{
			echo '<script type="text/javascript">alert("Password failed to update.");
			window.location.replace("UpdateMasterPassword.php")</script>';
		}
...
<head>
	...
	<title>Update Master password</title>
	<meta charset="utf-8">
...
<header>
 ...
 //	global $connection;
	...
	<h1 class="display-3" align="center">Update Master password</h1>
</header>
			  ...
			  <div class="modal-dialog">
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					<table>
						<tr>
							<td align="left" class="form-label"> Do you want to Update the master password? </td>
							<!-- <td align="left"><input type="text" id="user_pass" class="form-control" name="user_pass" readonly></td> -->
						</tr>
					</table>
				  </div>
